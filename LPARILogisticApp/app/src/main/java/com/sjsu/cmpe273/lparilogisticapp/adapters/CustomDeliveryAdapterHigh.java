...
public class CustomDeliveryAdapterHigh extends BaseAdapter {
    ...
    public CustomDeliveryAdapterHigh(Context context, ArrayList tripdropNodata, ArrayList tripdropTime,
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        View vi = convertView;
        if (vi == null) {
            vi = inflater.inflate(R.layout.list_row_delivery_high, null);
        }
